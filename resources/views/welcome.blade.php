<x-guest-layout>
    ...
    <div class="container max-w-lg px-4 py-32 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center"
        ...
        <h1
            ...
            <span class="inline md:block">Bem vindo ao Mundo Mágico das Festas!</span>
        </h1>
                ...
                <div class="order-1 w-full px-3 lg:w-1/2 lg:order-0">
                    <div class="w-full lg:max-w-md">
                        ...
                        <h2
                            ...
                            POR QUE USAR O NOSSO SERVIÇO?</h2>
                        ...
                        <ul>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                ...
                                <span class="font-medium text-gray-500">Sistema simples de usar</span>
                            </li>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                ...
                                <span class="font-medium text-gray-500">Pagamentos protegidos</span>
                            </li>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                <svg class="w-8 h-8 text-gray-500" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span class="font-medium text-gray-500">Segurança com os seus dados</span>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <section class="mt-8 bg-white">
        <div class="mt-4 text-center">
            <h3 class="text-2xl font-bold">Opções de comida</h3>
            <h2 class="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">
                RECOMENDAÇÃO DA COZINHA</h2>
        </div>
                ...
                @if ($menus->isNotEmpty())
                    @foreach ($menus as $menu)
                        <div class="max-w-xs mx-4 mb-2 rounded-lg shadow-lg">
                            <img class="w-full h-48" src="{{ url("/public/menus/$menu->image") }}" alt="Image" />
                            <div class="px-6 py-4">
